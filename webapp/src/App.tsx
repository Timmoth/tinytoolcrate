      ...
      <div className="mt-16 w-full text-white max-w-8xl">
        <div className="grid gap-4 m-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {panels.map((panel, index) => (
            <div key={index} className="relative flex flex-col p-4 border border-gray-100 rounded-lg shadow-sm bg-gray-700 h-full">
              <button
                type="button"
              ...
              <h2 className="text-center text-white text-lg font-bold mb-4">{panel}</h2>
